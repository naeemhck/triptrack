-- FAILSAFE ROLLBACK for 202608160001_default_route_leader.sql
-- Restores create_trip so new trips do not auto-assign the organizer as
-- Route Leader. Apply only if you also want that behavior undone:
--
